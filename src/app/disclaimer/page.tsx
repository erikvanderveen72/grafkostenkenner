...
export const metadata: Metadata = {
  title: 'Disclaimer',
  description: 'Disclaimer van Begraafplaatskosten.nl. Informatie over aansprakelijkheid en bronnen.',
};
        ...
        <div className="prose prose-stone max-w-none space-y-8">
          <div>
            ...
            <p className="text-text-muted leading-relaxed">
              De informatie op Begraafplaatskosten.nl is met grote zorgvuldigheid samengesteld op basis van officiële bronnen zoals gemeentelijke verordeningen en informatie van begraafplaatsen. Ondanks deze zorgvuldigheid is het mogelijk dat informatie onvolledig of onjuist is.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-text-muted leading-relaxed">
              Begraafplaatskosten.nl aanvaardt geen aansprakelijkheid voor schade die voortvloeit uit het gebruik van de informatie op deze website. De getoonde tarieven zijn indicatief. Neem altijd contact op met de betreffende begraafplaats voor actuele en bindende tarieven.
            </p>
          </div>
