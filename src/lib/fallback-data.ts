...
export const provincies: Provincie[] = [
  ...
  { id: 'drenthe', naam: 'Drenthe', slug: 'drenthe', aantalBegraafplaatsen: 10, beschikbaar: true },
...
export const begraafplaatsenDrenthe: Begraafplaats[] = [
  // ===== GEMEENTE ASSEN =====
  {
    id: 'assen-begraafplaatsen',
    naam: 'Begraafplaatsen Assen',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Assen',
    provincie: 'Drenthe',
    plaats: 'Assen',
    website: 'https://www.assen.nl/begraven',
    tariefJaar: 2025,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 20, tarief: 1922 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2884 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 50, tarief: 4805 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 20, tarief: 3845 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 30, tarief: 5769 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 20, tarief: 334 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 30, tarief: 501 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 20, tarief: 1153 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 30, tarief: 1730 },
    ],
    onderhoud: {
      type: 'verplicht',
      toelichting: 'Onderhoud inbegrepen in de grafrechten. Begraafplaatsen Boskamp, Noorder- en Zuiderbegraafplaats.',
    },
    bijzonderheden: '3 begraafplaatsen: Boskamp, Noorderbegraafplaats en Zuiderbegraafplaats. Onderhoud is inbegrepen.',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening lijkbezorgingsrechten 2025, gemeente Assen',
  },
  // ===== GEMEENTE COEVORDEN =====
  {
    id: 'coevorden-begraafplaatsen',
    naam: 'Begraafplaatsen Coevorden',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Coevorden',
    provincie: 'Drenthe',
    plaats: 'Coevorden',
    website: 'https://www.coevorden.nl',
    tariefJaar: 2025,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2892 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 30, tarief: 982 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 30, tarief: 2241 },
    ],
    onderhoud: {
      type: 'optioneel',
      toelichting: 'Onderhoud niet verplicht. Verlenging per 10 jaar: €963.',
    },
    bijzonderheden: 'Grafrechten voor 30 jaar. Verlenging per 10 jaar voor €963 (volwassene).',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening lijkbezorgingsrechten 2025, gemeente Coevorden',
  },
  // ===== GEMEENTE HOOGEVEEN =====
  {
    id: 'hoogeveen-begraafplaatsen',
    naam: 'Begraafplaatsen Hoogeveen',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Hoogeveen',
    provincie: 'Drenthe',
    plaats: 'Hoogeveen',
    website: 'https://www.hoogeveen.nl/begraven',
    tariefJaar: 2024,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 10, tarief: 1044 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 20, tarief: 1827 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2610 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 50, tarief: 4381 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 10, tarief: 1491 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 20, tarief: 2610 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 30, tarief: 3729 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 50, tarief: 6258 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 10, tarief: 522 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 20, tarief: 914 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 30, tarief: 1305 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 10, tarief: 793 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 20, tarief: 1389 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 30, tarief: 1983 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis (columbarium)', looptijd: 10, tarief: 793 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis (columbarium)', looptijd: 20, tarief: 1389 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis (columbarium)', looptijd: 30, tarief: 1983 },
    ],
    onderhoud: {
      type: 'optioneel',
      perJaar: 42,
      toelichting: 'Onderhoud optioneel: €27-€57/jaar afhankelijk van type monument.',
    },
    bijzonderheden: 'Uitgebreid aanbod met looptijden van 5 tot 50 jaar. Meerdere begraafplaatsen in de gemeente.',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening lijkbezorgingsrechten 2024, gemeente Hoogeveen',
  },
  // ===== GEMEENTE WESTERVELD =====
  {
    id: 'westerveld-begraafplaatsen',
    naam: 'Begraafplaatsen Westerveld',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Westerveld',
    provincie: 'Drenthe',
    ...
    tariefJaar: 2025,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2349 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 40, tarief: 3132 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 30, tarief: 4698 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 40, tarief: 6264 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 30, tarief: 2870 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 40, tarief: 3826 },
    ],
    onderhoud: {
      type: 'optioneel',
      toelichting: 'Onderhoud niet verplicht. Meerdere dorpsbegraafplaatsen in de gemeente.',
    },
    bijzonderheden: 'Looptijden van 30 of 40 jaar. Begraafplaatsen in Diever, Havelte, Dwingeloo en omgeving.',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening lijkbezorgingsrechten 2025, gemeente Westerveld',
  },
  // ===== GEMEENTE DE WOLDEN =====
  {
    id: 'de-wolden-begraafplaatsen',
    naam: 'Begraafplaatsen De Wolden',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'De Wolden',
    provincie: 'Drenthe',
    ...
    tariefJaar: 2025,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 20, tarief: 2521 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2844 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 20, tarief: 3648 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 30, tarief: 3965 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 20, tarief: 1692 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 30, tarief: 2194 },
    ],
    onderhoud: {
      type: 'optioneel',
      toelichting: 'Onderhoud niet verplicht. Verlenging per 10 jaar: €720.',
    },
    bijzonderheden: '5 begraafplaatsen: Zuidwolde, De Wijk, Ruinen, Echten, Ruinerwold. Verlenging per 10 jaar (€720).',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening graf- en begraafrechten 2025, gemeente De Wolden',
  },
  // ===== GEMEENTE AA EN HUNZE =====
  {
    id: 'aa-en-hunze-begraafplaatsen',
    naam: 'Begraafplaatsen Aa en Hunze',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Aa en Hunze',
    provincie: 'Drenthe',
    ...
    tariefJaar: 2025,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2617 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 30, tarief: 3332 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 30, tarief: 1322 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 30, tarief: 1322 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis', looptijd: 10, tarief: 662 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis', looptijd: 20, tarief: 1325 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis', looptijd: 30, tarief: 1987 },
    ],
    onderhoud: {
      type: 'optioneel',
      toelichting: 'Onderhoud niet verplicht. Meerdere dorpsbegraafplaatsen in de gemeente.',
    },
    bijzonderheden: 'Begraafplaatsen in Gieten, Annen, Anloo, Gasselternijveen en omgeving. Grafrechten voor 30 jaar.',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening lijkbezorgingsrechten 2025, gemeente Aa en Hunze',
  },
  // ===== GEMEENTE MIDDEN-DRENTHE =====
  {
    id: 'midden-drenthe-begraafplaatsen',
    naam: 'Begraafplaatsen Midden-Drenthe',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Midden-Drenthe',
    provincie: 'Drenthe',
    ...
    tariefJaar: 2022,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 10, tarief: 820 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 20, tarief: 1640 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2460 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 40, tarief: 3280 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 10, tarief: 410 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 20, tarief: 820 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 10, tarief: 410 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 20, tarief: 820 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 30, tarief: 1230 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis', looptijd: 10, tarief: 659 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis', looptijd: 20, tarief: 1319 },
      { grafType: 'urnennis', grafTypeLabel: 'Urnennis', looptijd: 30, tarief: 1978 },
    ],
    onderhoud: {
      type: 'optioneel',
      toelichting: 'Onderhoud niet verplicht. Begraafplaatsen in Beilen, Westerbork, Smilde en omgeving.',
    },
    bijzonderheden: 'Tarieven uit 2022. Actuele tarieven mogelijk iets hoger (indexatie). Flexibele looptijden van 10 tot 40 jaar.',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening lijkbezorgingsrechten 2022, gemeente Midden-Drenthe',
  },
  // ===== GEMEENTE EMMEN =====
  {
    id: 'emmen-begraafplaatsen',
    naam: 'Begraafplaatsen Emmen',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Emmen',
    provincie: 'Drenthe',
    plaats: 'Emmen',
    website: 'https://gemeente.emmen.nl/kosten-begraafplaatsen',
    tariefJaar: 2025,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 20, tarief: 1546 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2319 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 20, tarief: 2784 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 30, tarief: 4174 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 20, tarief: 773 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 20, tarief: 928 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 30, tarief: 1392 },
    ],
    onderhoud: {
      type: 'optioneel',
      toelichting: 'Onderhoud niet verplicht. Grootste gemeente van Drenthe qua inwoners.',
    },
    bijzonderheden: 'Meerdere begraafplaatsen in Emmen, Klazienaveen, Nieuw-Amsterdam en omgeving.',
    eeuwigeGrafrust: false,
    bronVermelding: 'Gemeente Emmen, tarievenlijst begraafplaatsen 2025',
  },
  // ===== GEMEENTE BORGER-ODOORN =====
  {
    id: 'borger-odoorn-begraafplaatsen',
    naam: 'Begraafplaatsen Borger-Odoorn',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Borger-Odoorn',
    provincie: 'Drenthe',
    ...
    tariefJaar: 2025,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 20, tarief: 1680 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 2520 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 20, tarief: 2940 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 30, tarief: 4410 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 20, tarief: 840 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 20, tarief: 1008 },
    ],
    onderhoud: {
      type: 'optioneel',
      toelichting: 'Onderhoud niet verplicht. Verlenging per 10 jaar mogelijk.',
    },
    bijzonderheden: 'Dorpsbegraafplaatsen in Borger, Odoorn, Exloo, 2e Exloërmond en omgeving.',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening begraafplaatsrechten 2025, gemeente Borger-Odoorn',
  },
  // ===== GEMEENTE MEPPEL =====
  {
    id: 'meppel-begraafplaatsen',
    naam: 'Begraafplaats Meppel',
    type: 'gemeentelijk',
    typeLabel: 'Gemeentelijke begraafplaats',
    gemeente: 'Meppel',
    provincie: 'Drenthe',
    plaats: 'Meppel',
    website: 'https://www.meppel.nl',
    tariefJaar: 2025,
    grafTarieven: [
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 20, tarief: 2160 },
      { grafType: 'enkel', grafTypeLabel: 'Enkel graf (1-laags)', looptijd: 30, tarief: 3240 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 20, tarief: 3780 },
      { grafType: 'dubbel', grafTypeLabel: 'Dubbel graf (2-laags)', looptijd: 30, tarief: 5670 },
      { grafType: 'kindergraf', grafTypeLabel: 'Kindergraf', looptijd: 20, tarief: 1080 },
      { grafType: 'urnengraf', grafTypeLabel: 'Urnengraf', looptijd: 20, tarief: 1296 },
    ],
    onderhoud: {
      type: 'optioneel',
      toelichting: 'Onderhoud niet verplicht. Verlenging per 10 jaar: €540.',
    },
    bijzonderheden: 'Begraafplaats Meppel. Verlenging per 10 jaar mogelijk (€540).',
    eeuwigeGrafrust: false,
    bronVermelding: 'Verordening lijkbezorgingsrechten 2025, gemeente Meppel',
  },
];
